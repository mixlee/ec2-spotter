...
export request_id=`../ec2spotter-launch_cn $config_file`
...
# add hostname tags:
aws ec2 create-tags --resources $instance_id --tags "Key=Name,Value=$ec2spotter_hostname"
...
then
	echo Then connect to your instance: ssh -i ~/.ssh/awscn-ai.pem ubuntu@$ip
fi
